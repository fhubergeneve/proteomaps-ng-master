// Generated on 2015-08-31 using generator-angular 0.9.8
'use strict';
  ...
  grunt.initConfig({
    ...
    ngconstant: {
        ...
        development: {
          ...
          constants: {
            ENV: {
              serverURL: 'http://www.proteomaps.local/api/index.php',
                      imageURL: 'http://www.proteomaps.local/api/image_get.php',
